...
IL_0085:
	...
	}
	{
		...
		RuntimeObject* L_23;
		L_23 = VirtualFuncInvoker5< RuntimeObject*, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t, AsyncCallback_t7FEF460CBDCFB9C5FA2EF776984778B9A4145F4C*, RuntimeObject* >::Invoke(14, __this, L_20, L_21, L_22, (AsyncCallback_t7FEF460CBDCFB9C5FA2EF776984778B9A4145F4C*)NULL, NULL);
		V_1 = L_23;
		RuntimeObject* L_24 = V_1;
		int32_t L_25;
		L_25 = VirtualFuncInvoker1< int32_t, RuntimeObject* >::Invoke(15, __this, L_24);
		return L_25;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Path_TryJoin_m5659FE5E59ABD7D9EB1F60D2F1322A28126FC662 (ReadOnlySpan_1_t59614EA6E51A945A32B02AB17FBCBDF9A5C419C1 ___0_path1, ReadOnlySpan_1_t59614EA6E51A945A32B02AB17FBCBDF9A5C419C1 ___1_path2, Span_1_tEDDF15FCF9EC6DEBA0F696BAACDDBAB9D92C252D ___2_destination, int32_t* ___3_charsWritten, const RuntimeMethod* method) 
{
	...
	ReadOnlySpan_1_t59614EA6E51A945A32B02AB17FBCBDF9A5C419C1* G_B24_3 = NULL;
	{
		...
		*((int32_t*)L_0) = (int32_t)0;
		int32_t L_1 = (&___0_path1)->____length;
		if (L_1)
		{
			goto IL_0017;
		}
	...
	{
		int32_t L_2 = (&___1_path2)->____length;
		if (L_2)
		{
			goto IL_0017;
		}
...
IL_0017:
	{
		int32_t L_3 = (&___0_path1)->____length;
		if (!L_3)
		{
			goto IL_0029;
		}
...
IL_0029:
	{
		int32_t L_5 = (&___0_path1)->____length;
		if (!L_5)
		{
			goto IL_0036;
		}
...
IL_0038:
	{
		V_2 = G_B8_0;
		int32_t L_6 = (&___2_destination)->____length;
...
IL_006f:
	{
		V_0 = (bool)G_B14_0;
		int32_t L_18 = (&___0_path1)->____length;
		int32_t L_19 = (&___1_path2)->____length;
		bool L_20 = V_0;
		if (L_20)
		{
...
IL_0086:
	{
		...
		int32_t L_21 = (&___2_destination)->____length;
		int32_t L_22 = V_1;
		if ((((int32_t)L_21) >= ((int32_t)L_22)))
		{
			goto IL_0094;
...
IL_0094:
	...
	{
		int32_t L_25 = (&___0_path1)->____length;
		Il2CppChar* L_26;
...
IL_00b3:
	{
		int32_t L_28 = (&___0_path1)->____length;
		bool L_29 = V_0;
		if (L_29)
		{
			G_B23_0 = L_28;
